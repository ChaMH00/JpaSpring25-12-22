...
* DTO : 객체를 생성하는 클래스
* JPA Auditing : reg_date, mod_date 등로길, 수정일 같은
* 모든 클래스에 동이랗게 사용되는 칼럼을 별도로 관리 => base
* @id => primary key
...
public class Board extends TimeBase{
    ...
    @Column(name = "cmtQty", columnDefinition = "int default 0")
    private int cmtQty;
    @Column(name = "fileQty", columnDefinition = "int default 0")
    private int fileQty;
